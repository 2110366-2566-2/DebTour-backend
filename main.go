...
func main() {
	...
	v1 := router.Group("/api/v1")
	{
		...
		v1.POST("/agencies/companyInformation/:username", middleware.AuthorizeJWT([]string{"Agency"}, 1), controllers.CreateCompanyInformationByAgencyUsername)            // agency themselves
